...
public class MainGUI extends javax.swing.JFrame implements ActionListener {
    ...
    private void btnEnterRecordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnterRecordActionPerformed
        //This is already stated on line 27.
        //foundIndex = NOT_FOUND;

        //An ErrorMsgs class has been created to handle the output messages
        //associated with errors generated below.
        //The intention is that if a new program created later on needs the same
        //error messages, the text and work is not duplicated.
        //Simply, the ErrorMsgs class can be accessed.
        ErrorMsgs em = new ErrorMsgs();
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, em.getErrorMsg1(),
...
//            return;
        ...
        if (emptyRow > 10) {
            JOptionPane.showMessageDialog(this, em.getErrorMsg2(),
                    "Maximum Reached", JOptionPane.WARNING_MESSAGE);
...
//                    + "No more items can be saved.", "Maximum Reached", JOptionPane.WARNING_MESSAGE);
            ...
            JOptionPane.showMessageDialog(this, em.getErrorMsg3(),
